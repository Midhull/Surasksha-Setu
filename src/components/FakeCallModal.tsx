...
export function FakeCallModal({ isOpen, onClose, enabled, onToggle }: FakeCallModalProps) {
    ...
    >
       ...
       >
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-sm uppercase tracking-widest text-silver font-bold">Fake Call Escape</h2>
          ...
          <div className="space-y-8">
            <div className="flex justify-between items-center glass-panel p-5 rounded-2xl bg-white/[0.02] border-white/5">
              <div>
                <p className="text-sm text-silver font-medium">Enable Fake Call</p>
                <p className="text-[10px] text-silver/40 uppercase tracking-widest mt-1">Simulate an incoming call</p>
              </div>
            ...
            <div className="pt-4 space-y-4">
              <button onClick={() => alert("Fake Call Activated")} className="w-full py-4 rounded-xl border border-white/10 text-[11px] font-bold uppercase tracking-widest text-silver hover:bg-white/5 transition-colors">
                Test Fake Call
              </button>
              <p className="text-center text-[10px] text-silver/20 leading-relaxed px-4 mt-8">Use this to gracefully exit uncomfortable situations.</p>
            </div>
          </div>
       </motion.div>
    </motion.div>
